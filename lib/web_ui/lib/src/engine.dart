...
part 'engine/html/path/intersections/cubic_classifier.dart';
part 'engine/html/path/intersections/cubic_intersections.dart';
part 'engine/html/path/intersections/intersections.dart';
part 'engine/html/path/intersections/line.dart';
part 'engine/html/path/intersections/line_intersections.dart';
part 'engine/html/path/intersections/op_angle.dart';
part 'engine/html/path/intersections/op_coincidence.dart';
part 'engine/html/path/intersections/op_contour.dart';
part 'engine/html/path/intersections/op_contour_builder.dart';
part 'engine/html/path/intersections/op_point.dart';
part 'engine/html/path/intersections/op_segment.dart';
part 'engine/html/path/intersections/op_span.dart';
part 'engine/html/path/intersections/path_writer.dart';
part 'engine/html/path/intersections/tcurve.dart';
part 'engine/html/path/intersections/tsect.dart';
part 'engine/html/path/intersections/tspan.dart';
part 'engine/html/path/intersections/line_parameters.dart';
part 'engine/html/path/intersections/op_builder.dart';
...
part 'engine/html/path/quad.dart';
part 'engine/html/path/intersections/reduce_order.dart';
