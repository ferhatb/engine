...
part 'engine/surface/path/intersections/cubic_classifier.dart';
part 'engine/surface/path/intersections/cubic_intersections.dart';
part 'engine/surface/path/intersections/intersections.dart';
part 'engine/surface/path/intersections/line.dart';
part 'engine/surface/path/intersections/line_intersections.dart';
part 'engine/surface/path/intersections/op_angle.dart';
part 'engine/surface/path/intersections/op_coincidence.dart';
part 'engine/surface/path/intersections/op_contour.dart';
part 'engine/surface/path/intersections/op_contour_builder.dart';
part 'engine/surface/path/intersections/op_point.dart';
part 'engine/surface/path/intersections/op_segment.dart';
part 'engine/surface/path/intersections/op_span.dart';
part 'engine/surface/path/intersections/path_writer.dart';
...
part 'engine/surface/path/intersections/line_parameters.dart';
part 'engine/surface/path/intersections/op_builder.dart';
...
part 'engine/surface/path/quad.dart';
part 'engine/surface/path/intersections/reduce_order.dart';
